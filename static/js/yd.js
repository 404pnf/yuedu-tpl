...
(function() {
  ...
  YD.user = function() {
    var grades, photos, setDaysOfMonth, userBarShow, userEdit, userInfoAll, userPhotoEdit, userPhotoSave, userRender, userSave, userShow, userinfo;
    ...
    setDaysOfMonth = function() {
      return $('select').change(function() {
        var isLeap, lunarMonth, month, solarMonth, year;
        ...
        lunarMonth = [4, 6, 9, 11];
        if ((__indexOf.call(isLeap, year) >= 0) && (month === 2)) {
          note("here");
          $("#day option[value='31']").remove();
          return $("#day option[value='30']").remove();
        } else if (month === 2) {
          note("i am here");
          $("#day option[value='31']").remove();
          $("#day option[value='30']").remove();
          return $("#day option[value='29']").remove();
        } else if (__indexOf.call(lunarMonth, month) >= 0) {
          return $("#day option[value='31']").remove();
        }
      });
    };
